/*
  ...
  - You are about to drop the column `crecreateAt` on the `Booking` table. All the data in the column will be lost.
  - You are about to drop the column `updated` on the `Booking` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Booking" DROP COLUMN "crecreateAt",
DROP COLUMN "updated",
ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
